...
<td><?php echo $row['description']; ?></td>
            ...
            <td>
              <button style="background:none;border:none;" class="btn btn-secondary edit-btn" data-toggle="modal" data-target="#updateModal" data-id="<?php echo $row['id']; ?>" data-products_id="<?php echo $row['products_id']; ?>" data-products_name="<?php echo $row['products_name']; ?>" data-image="<?php echo $row['image']; ?>" 
              data-description="<?php echo $row['description']; ?>"
              data-unit_price="<?php echo $row['unit_price']; ?>" data-total_units="<?php echo $row['total_units']; ?>" data-reserved_units="<?php echo $row['reserved_units']; ?>">
            ...
            <div class="modal-body">
                <form action="update.php" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" min="0" class="form-control" id="product_price" name="product_price" placeholder="Enter unit price" required="">
                    </div>
                    <div class="form-group">
