...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['update_product'])) {
    ...
    $stmt->bind_param("sssdiissssssss", $product_products_id, $product_name, $product_image, $product_description, $product_unit_price, $product_total_units, $specs_cpu, $specs_motherboard, $specs_ram, $specs_ssd, $specs_monitor, $specs_computercase, $specs_powersupply, $specs_fan);
