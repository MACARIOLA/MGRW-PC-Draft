...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_FILES["fileToUpload"])) {
    ...
    $delete_previous_query = "DELETE FROM printer_pricelist_tbl";
    ...
    if ($uploadOk == 0) {
        ...
        if (move_uploaded_file($_FILES["fileToUpload"]["tmp_name"], $target_file)) {
            ...
            $sql = "INSERT INTO printer_pricelist_tbl (filename, filepath) VALUES ('". basename( $_FILES["fileToUpload"]["name"]) ."', '". $target_file ."')";
