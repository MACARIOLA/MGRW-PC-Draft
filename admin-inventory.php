...
<body>
            ...
            <main class="table" id="customers_table">
                ...
                <section class="table__body">
                    <table id="inventoryTable">
                        ...
                        <tbody>
                            <?php 
                                $sql = "SELECT * FROM inventory  WHERE 	products_id  LIKE '%SULIT PC%'";
                                    ...
                                    while ($row = mysqli_fetch_assoc($result)) {
                                        ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <button style="background:none;border:none;" class="btn btn-secondary edit-btn" data-toggle="modal" data-target="#updateModalPC" 
    ...
    <!---------------
     SULIT PC POPUP
    ---------------->
    <div class="modal fade" id="updateModalPC" tabindex="-1" role="dialog" aria-labelledby="updateModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="updateModalLabel">Update Sulit PC</h5>
    ...
    <div class="modal fade" id="addModal" tabindex="-1" role="dialog" aria-labelledby="addModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="updateModalLabel">Sulit PC</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
        ...
        <div class="container1">
            <main class="table" id="customers_table">
                ...
                <section class="table__header">
                    ...
                    <button class='add' data-toggle="modal" data-target="#addLaptop">ADD</button>
                </section>
                ...
                <section class="table__body">
                    <table id="inventoryTable">
                        ...
                        <tbody>
                            <?php 
                                $sql = "SELECT * FROM inventory WHERE 	products_id  LIKE '%SULIT LAPTOP%'";
                                $result = mysqli_query($conn, $sql);
                                if ($result && mysqli_num_rows($result) > 0) {
                                    while ($row = mysqli_fetch_assoc($result)) {
                                        ?>
                                            <tr>
                                                ...
                                                <td><?php echo htmlspecialchars($row['reserved_units']); ?></td>
                                                <td>
                                                    <button style="background:none;border:none;" class="btn btn-secondary edit-btn" data-toggle="modal" data-target="#updateLaptop" 
                                                        data-id="<?php echo htmlspecialchars($row['id']); ?>" 
                                                        data-products_id="<?php echo htmlspecialchars($row['products_id']); ?>" 
                                                        data-products_name="<?php echo htmlspecialchars($row['products_name']); ?>" 
                                                        data-image="<?php echo base64_encode($row['image']); ?>" 
    ...
    <!---------------
     SULIT LAPTOP POPUP
    ---------------->
    <div class="modal fade" id="updateLaptop" tabindex="-1" role="dialog" aria-labelledby="updateModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="updateModalLabel">Update Sulit Laptop</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
    ...
    <!---------------
        ADD SULIT LAPTOP
    ---------------->
    <div class="modal fade" id="addLaptop" tabindex="-1" role="dialog" aria-labelledby="addModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="updateModalLabel">Sulit Laptop</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
        ...
        <div class="container1">
            <main class="table" id="customers_table">
                ...
                <section class="table__header">
                    ...
                    <button class='add' data-toggle="modal" data-target="#addPrinter">ADD</button>
                </section>
                ...
                <section class="table__body">
                    <table id="inventoryTable">
                        ...
                        <tbody>
                            <?php 
                                $sql = "SELECT * FROM inventory WHERE 	products_id  LIKE '%SULIT PRINTER%'";
                                $result = mysqli_query($conn, $sql);
                                if ($result && mysqli_num_rows($result) > 0) {
                                    while ($row = mysqli_fetch_assoc($result)) {
                                        ?>
                                            <tr>
                                                ...
                                                <td><?php echo htmlspecialchars($row['reserved_units']); ?></td>
                                                <td>
                                                    <button style="background:none;border:none;" class="btn btn-secondary edit-btn" data-toggle="modal" data-target="#updatePrinter" 
                                                        data-id="<?php echo htmlspecialchars($row['id']); ?>" 
                                                        data-products_id="<?php echo htmlspecialchars($row['products_id']); ?>" 
                                                        data-products_name="<?php echo htmlspecialchars($row['products_name']); ?>" 
                                                        data-image="<?php echo base64_encode($row['image']); ?>" 
    ...
    <!---------------
     SULIT PRINTER POPUP
    ---------------->
    <div class="modal fade" id="updatePrinter" tabindex="-1" role="dialog" aria-labelledby="updateModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="updateModalLabel">Update Sulit Printer</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
    ...
    <!---------------
        ADD SULIT PRINTER
    ---------------->
    <div class="modal fade" id="addPrinter" tabindex="-1" role="dialog" aria-labelledby="addModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="updateModalLabel">Sulit Printer</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
